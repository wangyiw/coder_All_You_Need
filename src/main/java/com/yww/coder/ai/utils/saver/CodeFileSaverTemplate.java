...
import com.yww.coder.constant.AppConstant;
...
public abstract class CodeFileSaverTemplate<T> {
    ...
    protected void validateInput(T result) {
        if (result == null) {
            throw new InvalidContentException(InvalidContentSubStatusEnum.PARAMS_ERROR, "代码结果对象不能为空");
        }
    }
    ...
    protected String buildUniqueDir(Long appId) {
        if (appId == null) {
            throw new InvalidContentException(InvalidContentSubStatusEnum.PARAMS_ERROR, "应用 ID 不能为空");
        }
     ...
     * @return 代码生成类型枚举
     */
    protected abstract CodeGenerateTypeEnum getCodeType();
}
